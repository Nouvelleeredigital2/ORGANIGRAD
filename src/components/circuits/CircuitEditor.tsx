...
export function CircuitEditor({options,initial,onSave,onCancel,allowBotApproval=false}:{options:CircuitOptions;initial?:CircuitDefinition;onSave:(d:CircuitDefinition)=>Promise<unknown>|unknown;onCancel:()=>void;allowBotApproval?:boolean}) {
