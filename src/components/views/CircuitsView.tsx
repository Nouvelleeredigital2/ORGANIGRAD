...
import { CircuitManualStart } from '../circuits/CircuitManualStart';
import { BorealProductionSetup } from '../circuits/BorealProductionSetup';
...
function CircuitWorkspace() {
 ...
 const {userId,activeId}=useWorkspaceContext();const [tab,setTab]=useState<'definitions'|'runs'>('definitions');
